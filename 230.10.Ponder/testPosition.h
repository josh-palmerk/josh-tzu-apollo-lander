...
private:
   ...
   void add_moving()
   {
       ...
       double time(1.0);
       pos.add(acc, vel, time);
       assertEquals(pos.x, 11.6); // 11.6 = 11.1 + 0.5*1
	   assertEquals(pos.y, 22.6); // 22.6 = 22.2 + 0.4*1
   }
   ...
   void add_movingLonger()
   {
       ...
       double time(2.0);
       pos.add(acc, vel, time);
       assertEquals(pos.x, 12.1); // 12.1 = 11.1 + 0.5*2
	   assertEquals(pos.y, 23.0); // 23.0 = 22.2 + 0.4*2
   }
   ...
   void add_fromStop()
   {
       ...
       double time(1.0);
       pos.add(acc, vel, time);
       assertEquals(pos.x, 11.20); // 11.20 = 11.1 + 1/2 .2 1^2
	   assertEquals(pos.y, 22.35); // 22.35 = 22.2 + 1/2 .3 1^2
   }
   ...
   void add_fromStopLonger()
   {
       ...
       double time(2.0);
       pos.add(acc, vel, time);
       assertEquals(pos.x, 11.5); // 11.5 = 11.1 + 1/2 .2 2^2
	   assertEquals(pos.y, 22.8); // 22.8 = 22.2 + 1/2 .3 2^2
   }
